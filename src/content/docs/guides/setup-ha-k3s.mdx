...
│ │ HAProxy instance    │ │ │ │ KHAProxy instance   │ │ │ │ HAProxy instance    │ │
...
<Aside type="tip">
  This architecture ensures no single point of failure. Even if two nodes fail simultaneously, the cluster remains operational with the remaining node.
</Aside>
